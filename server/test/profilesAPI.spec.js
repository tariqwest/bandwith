...
describe('Profiles API', () => {
  ...
  xit('accepts GET requests to /api/profiles', (done) => {
    request(app)
      .get('/api/profiles')
      .expect((res) => {
        res.body = {
  ...
  xit('accepts GET requests to /api/profiles/:id', (done) => {
    request(app)
      .get('/api/profiles/1')
      .expect((res) => {
        res.body = {
  ...
  xit('sends 404 if id on GET requests to /api/profiles/:id does not exist', (done) => {
    request(app)
  ...
  // it('accepts POST requests to /api/profiles', (done) => {
  //   request(app)
  //     .post('/api/profiles')
  //     .send({
  //       username: 'TestUser4',
  ...
  xit('accepts PUT requests to /api/profiles/:id', () => {
    const profile = {
      first: 'James',
      last: 'Davenport',
  ...
  xit('sends 404 if id on PUT requests to /api/profiles/:id does not exist', (done) => {
    request(app)
