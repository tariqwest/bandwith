...
export const CHATS_SENT_ADD = 'CHATS_SENT_ADD';
export const CHATS_RECEIVED_ADD = 'CHATS_RECEIVED_ADD';
...
export const addSentChat = sentChat => ({
  type: CHATS_SENT_ADD,
  isFetching: false,
  sentChat,
});

export const addReceivedChat = receivedChat => ({
  type: CHATS_RECEIVED_ADD,
  isFetching: false,
  receivedChat,
});
